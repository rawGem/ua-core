...
AT.prototype.setupRoutes = function() {
    if (Meteor.isServer){
        ...
        console.log("AT routes: ", AccountsTemplates.routes)
    ...
    _.each(AccountsTemplates.routes, function(options, route){
      console.log("options [routes iteration] ", options)
      console.log("route [routes iteration] ", route)
